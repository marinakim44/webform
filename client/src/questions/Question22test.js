...
//   useEffect(() => {
//     window.scrollTo(0, 0);
//     // if (localStorage.getItem("q22-dontknowRevenue")) {
//     //   setDontknowRevenue(localStorage.getItem("q22-dontknowRevenue"));
//     // }
//     // if (localStorage.getItem("q22-dontknowProfit")) {
//     //   setDontknowProfit(localStorage.getItem("q22-dontknowProfit"));
//     // }
//     // if (localStorage.getItem("q22-dontknowReturn")) {
//     //   setDontknowReturn(localStorage.getItem("q22-dontknowReturn"));
//     // }
...
//   useEffect(() => {
//     if (dontknowReturn === false) {
//       setErrorReturn(false);
//       setReturnInput("");
//     }
//     if (dontknowProfit === false) {
//       setErrorProfit(false);
//       setProfit("");
//     }
//     if (dontknowRevenue === false) {
//       setErrorRevenue(false);
//       setRevenue("");
//     }
//   }, [dontknowRevenue, dontknowProfit, dontknowReturn]);
...
//                   style={{
//                     backgroundColor: dontknowProfit ? "#db536a" : "#dedede",
...
//                   style={{
//                     backgroundColor: localStorage.getItem("q22-dontknowReturn")
//                       ? "#db536a"
//                       : "#dedede",
...
//                           value={revenue}
//                           onChange={handleChangeRevenue}
//                           disabled={dontknowRevenue === true ? true : false}
//                           onBlur={handleBlurRevenue}
//                           onFocus={handleFocusRevenue}
//                         />
//                       </Col>
...
//                       style={{
//                         backgroundColor:
//                           dontknowRevenue === true ? "#db536a" : "#dedede",
//                         color: dontknowRevenue === true ? "white" : "black",
//                         borderColor:
//                           dontknowRevenue === true ? "#db536a" : "#dedede",
//                       }}
//                     >
...
//                           value={profit}
//                           onChange={handleChangeProfit}
//                           disabled={dontknowProfit === true ? true : false}
//                           onBlur={handleBlurProfit}
//                           onFocus={handleFocusProfit}
//                         />
//                       </Col>
...
//                       style={{
//                         backgroundColor:
//                           dontknowProfit === true ? "#db536a" : "#dedede",
//                         color: dontknowProfit === true ? "white" : "black",
//                         borderColor:
//                           dontknowProfit === true ? "#db536a" : "#dedede",
//                       }}
//                     >
...
//                           value={returnInput}
//                           onChange={handleChangeReturn}
//                           disabled={dontknowReturn === true ? true : false}
//                           onBlur={handleBlurReturn}
//                           onFocus={handleFocusReturn}
//                         />
//                       </Col>
...
//                       style={{
//                         backgroundColor:
//                           dontknowReturn === true ? "#db536a" : "#dedede",
//                         color: dontknowReturn === true ? "white" : "black",
//                         borderColor:
//                           dontknowReturn === true ? "#db536a" : "#dedede",
//                       }}
//                     >
