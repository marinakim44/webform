...
export default function QuestionH({ lng }) {
          ...
          {lng === "English" ? (
            <>
              <p className="question">
                Does your company have any form of government ownership or
                backing?
              </p>
            ...
            <>
              <p className="question">
                Имеет ли ваша компания государственную собственность или
                поддержку в какой-либо форме?
              </p>
              <p className="question-i">
